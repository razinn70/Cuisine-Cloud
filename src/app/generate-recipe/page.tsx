                    ...
                    <h3 className="text-xl font-headline mb-4">Nutritional Information (Estimated)</h3>
                     <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-center">
                        <div className="bg-secondary p-3 rounded-lg">
                            <p className="font-bold text-lg">{generatedRecipe.nutrition?.calories ?? 'N/A'}</p>
                            <p className="text-sm text-muted-foreground">Calories</p>
                        </div>
                         <div className="bg-secondary p-3 rounded-lg">
                            <p className="font-bold text-lg">{generatedRecipe.nutrition?.protein ? `${generatedRecipe.nutrition.protein}g` : 'N/A'}</p>
                            <p className="text-sm text-muted-foreground">Protein</p>
                        </div>
                         <div className="bg-secondary p-3 rounded-lg">
                            <p className="font-bold text-lg">{generatedRecipe.nutrition?.carbs ? `${generatedRecipe.nutrition.carbs}g` : 'N/A'}</p>
                            <p className="text-sm text-muted-foreground">Carbs</p>
                        </div>
                         <div className="bg-secondary p-3 rounded-lg">
                            <p className="font-bold text-lg">{generatedRecipe.nutrition?.fat ? `${generatedRecipe.nutrition.fat}g` : 'N/A'}</p>
